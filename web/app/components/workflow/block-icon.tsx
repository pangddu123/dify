...
const DEFAULT_ICON_MAP: Record<BlockEnum, React.ComponentType<{ className: string }>> = {
  ...
  [BlockEnum.EnsembleAggregator]: VariableX,
  [BlockEnum.ParallelEnsemble]: VariableX,
  [BlockEnum.TokenModelSource]: VariableX,
...
const ICON_CONTAINER_BG_COLOR_MAP: Record<string, string> = {
  ...
  [BlockEnum.EnsembleAggregator]: 'bg-util-colors-indigo-indigo-500',
  [BlockEnum.ParallelEnsemble]: 'bg-util-colors-indigo-indigo-500',
  [BlockEnum.TokenModelSource]: 'bg-util-colors-indigo-indigo-500',
